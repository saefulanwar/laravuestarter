                ...
                <div class="card">
                    <div class="card-header p-2">
                        <ul class="nav nav-pills">
                            <li class="nav-item"><a href="#activity" class="nav-link" data-toogle="tab">Activity</a></li>
                            <li class="nav-item"><a href="#settings" class="nav-link active show" data-toogle="tab">Settings</a></li>
                        </ul>
                    </div> <!--card-header-->
                                ...
                                <form class="form-horizontal">
                                    <div class="form-group">
                                     ...
                                     <div class="form-group">
                                        ...
                                        <div class="col-sm-12">
                                        <textarea name="" v-model="form.bio" id="inputExperience" class="form-control" placeholder="Experience"></textarea>
                                        <has-error field="name"></has-error>
                                        </div>
                                    </div>
